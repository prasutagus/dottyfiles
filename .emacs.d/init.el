...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (spacegray-theme subatomic-theme immaterial-theme emmet-mode spaceline dashboard which-key use-package smartparens railscasts-reloaded-theme flycheck elpy dracula-theme better-defaults autopair auto-complete)))
